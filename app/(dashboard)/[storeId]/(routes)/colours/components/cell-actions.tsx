...
import { ColoursColumn } from './columns'
import {
    DropdownMenu,
    DropdownMenuContent,
    DropdownMenuItem,
       ...
       <>
        <DropdownMenu>
            ...
            <DropdownMenuContent align='end'>
                ...
                <DropdownMenuItem onClick={()=> router.push(`/${params.storeId}/colours/${data.id}`)}><Edit className='mr-2 h-4 w-4' />Update</DropdownMenuItem>
